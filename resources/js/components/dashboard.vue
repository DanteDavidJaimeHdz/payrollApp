                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">$ {{ weekEarnings }}</div>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="chart-area">
                            <line-chart :data="{'2017-05-13': 2, '2017-05-14': 5}" width="100%" height="100%"></line-chart>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="chart-pie pt-4 pb-2">
                            <pie-chart :data="[['Blueberry', 44], ['Strawberry', 23]]" width="100%" height="100%"></pie-chart>
                        </div>
                    </div>
                </div>
            </div>
